...
// XXX HACK use CustomScrollViewStickyHeader so we can take control the wrapper styles of it. Without it, the child.props.style in original ScrollViewStickyHeader is always pass to CellRenderer in VirtualizedList, which the custom z-index does not take effect
import ScrollViewStickyHeader from './CustomScrollViewStickyHeader';
...
class ScrollView extends React.Component {
   ...
   */
  _inputMeasureAndScrollToKeyboard = (left, top, width, height) => {
  ...
  render() {
    ...
    if (stickyHeaderIndices != null && stickyHeaderIndices.length > 0) {
      ...
      children = childArray.map((child, index) => {
        ...
        // XXX HACK render all children as StickyHeaderComponent to maintain the same node tree for avoid re-render
        return (
          <StickyHeaderComponent
            ...
            wrapperStyle={[
              styles.stickyHeader,
              indexOfIndex > -1 && styles.stickyHeaderActive,
            ]}
            ...
            {...indexOfIndex > -1 ? {
              ...
              onLayout: () => {},
              scrollAnimatedValue: new AnimatedImplementation.Value(0), // TODO
            }}
          >
            {child}
          </StickyHeaderComponent>
